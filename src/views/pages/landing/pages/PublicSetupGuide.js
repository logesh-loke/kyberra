...
const PublicSetupGuide = () => {
  return (
    <div className="bg-gradient-to-b from-white via-slate-50 to-white fixed top-0 left-0 h-[100vh] overflow-y-auto w-full z-[9999]">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-10 sm:py-14 lg:py-20">
        {/* Header */}
        <div className="text-center max-w-3xl mx-auto mb-12">
          <p className="flex flex-col items-center gap-4">
            <span>
              <img src={logo} alt="Crypsyn Logo" className=" h-12" />
              </span>
              <span  className="text-2xl sm:text-3xl lg:text-4xl  text-gray-900">
                 Secure Mail Setup Guide
                </span>
          </p>
